...
import com.gonzapolleria.kmp2025.ActivityContextProvider
...
actual class GoogleAuthClient actual constructor() {
    private val context: Context = ActivityContextProvider.context
    private val tag = "GoogleAuthClient: "
    private val credentialManager = CredentialManager.create(context)
    private val firebaseAuth = FirebaseAuth.getInstance()

    actual fun isSingedIn(): Boolean {
        ...
        val request = GetCredentialRequest.Builder()
            .addCredentialOption(
                GetGoogleIdOption.Builder()
                    ...
                    .setServerClientId(
                        "696985231159-2diso3rj955iuifd5v8bi7k207vn60ff.apps.googleusercontent.com"
                    )
